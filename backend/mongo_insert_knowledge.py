...
import certifi
from utils.knowledge_sync import knowledge_base_en  # ✅ Import your English knowledge base safely

# 🌿 --- MongoDB Connection ---
try:
    # ✅ Use your real username & password — no < > symbols
    uri = "mongodb+srv://kani_15:kanigaravi@cluster30.c6fxhae.mongodb.net/?retryWrites=true&w=majority&appName=Cluster30"
    client = MongoClient(uri, tlsCAFile=certifi.where())
    
    db = client["RiceCropDB"]               # Database name
